  ...
  var element;
  var method;
  var xlabel = [], wlabel = []; var lblabel=[],ublabel=[];
  method = "Primal";
  ...
  function setExercise(v) {
	  ...
	  if (v.valueOf() == "HW_3_2") {
		...
		toGrid();
	      ...
	      m = 2; document.getElementById("m").value = m;
	      n = 4; document.getElementById("n").value = n;
	      method = "No preference"; document.getElementById("method").value = method;
	      start();
	...
	if (method == "Primal") {
		...
		if(document.getElementById("mb"+0).className=="maxvar"){
			...
			if(up[col].className=="purpleval"){ 
					...
					if (a[row][col] > eps && (lb[row]-vb[row])/(-a[row][col]) < tmp+eps) {
		    					document.getElementById("w"+col+","+(n+1)).className = "butvar";
					} 
					else if (a[row][col] <- eps &&(ub[row]-vb[row])/(-a[row][col]) < tmp+eps) {
		    					document.getElementById("w"+col+","+(n+2)).className = "butvar";
					}
	      		}
